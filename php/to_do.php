<!-- When the visitor to the website, modifies the task list, 
a request is made for a new web page, the PHP code 
runs again in the back-end and delivers a new version 
of the site with updated HTML -->
